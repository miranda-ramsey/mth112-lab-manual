...
\section{Trigonometric Identities} \label{section-trig-identities}
...
\subsection*{Preparation Exercises} \label{preparation-exercises-section-trig-identities}
...
\begin{multicols}{2}
	\begin{myPrep}
		Using a calculator, accurately sketch a graph of $f(x)=4\sin\left(\frac{\pi}{3}(x-2)\right)+x$ on the axes shown in Figure \ref{fig:section-trig-identities-intro-graph} .
		\begin{center}\captionsetup{type=figure}\captionof{figure}{Sketch a graph of $f$ here}
			\begin{tikzpicture}\label{fig:section-trig-identities-intro-graph}
 				\begin{axis}[
 					framed,
					xmin=-8,xmax=8,
 					ymin=-10,ymax=8,
...
\subsection*{Practice Exercises} \label{practice-exercises-section-trig-identities}
...
\begin{myPractice}
	...
	\begin{multicols}{2}
		\begin{itemize}
			\item Make a graph of the left-hand side of the equation onto Figure \ref{fig:section-trig-identities-sec-cos}, $y=\sec(x)-\cos(x)$, using technology.
			\vfill
			\item Make a graph of the right-hand side of the equation onto Figure \ref{fig:section-trig-identities-sec-cos}, $y=\sin(x)\tan(x)$, using technology.
			\vfill
		...
		\begin{center}\captionsetup{type=figure}\captionof{figure}{Sketch a graph here}
			\begin{tikzpicture}\label{fig:section-trig-identities-sec-cos}
 				\begin{axis}[
 					framed,
...
\subsection*{Definitions} \label{definitions-section-trig-identities}

\begin{myDefinition}[{Identity}]~\\[0.5mm]
	An \textbf{identity} is an equation that is always true, regardless of the value inputted.
\end{myDefinition}

\begin{myDefinition}[{Identities for tangent, cotangent, secant, and cosecant}]~\\[0.5mm]
...
\begin{myDefinition}[{Pythagorean identities}]~\\[0.5mm]
...
\subsection*{Exit Exercises} \label{exit-exercises-section-trig-identities}
